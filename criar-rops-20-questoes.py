...
# -*- coding: utf-8 -*-
"""
Cria ROPs com 20 questões por ROP para garantir carregamento
"""

import re

def create_rops_20_questions():
    print("🔄 CRIANDO ROPs COM 20 QUESTÕES POR ROP...")
    print("=" * 70)
    ...
    # Criar arquivo completo com 20 questões
...
'''
    ...
    # Adicionar ROPs 3.1-3.6 com 20 questões cada
    for i in range(1, 7):
        rop_key = f"rop-3-{i}"
        rop_var = f"rop_3_{i}"
...
'''
    ...
    # Adicionar ROPs 4.1-4.5 com 20 questões cada
    for i in range(1, 6):
        rop_key = f"rop-4-{i}"
        rop_var = f"rop_4_{i}"
...
'''
    ...
    # Adicionar ROPs 5.1-5.4 com 20 questões cada
    for i in range(1, 5):
        rop_key = f"rop-5-{i}"
        rop_var = f"rop_5_{i}"
...
'''
    ...
    # Adicionar ROPs 6.1-6.5 com 20 questões cada
    for i in range(1, 6):
        rop_key = f"rop-6-{i}"
        rop_var = f"rop_6_{i}"
...
'''
    ...
    # Salvar arquivo
    with open('rops-data-20-questions.js', 'w', encoding='utf-8') as f:
        f.write(complete_content)
    
    # Verificar tamanho
    import os
    size_kb = os.path.getsize('rops-data-20-questions.js') / 1024
    
    print("\n" + "=" * 70)
    print("✅ ROPs OTIMIZADO CRIADO!")
    print(f"📊 Tamanho: {size_kb:.1f}KB")
    print("📄 Arquivo: rops-data-20-questions.js")
    print("🎯 20 questões por ROP para carregamento garantido!")
